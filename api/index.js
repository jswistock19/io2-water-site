// Vercel serverless function wrapping our Express app
const path = require('path');

// Patch __dirname for the bundled server
const serverPath = path.join(process.cwd(), 'dist', 'index.cjs');

let app;
try {
  // The built server exports or creates an Express app on port 5000
  // We need to intercept it. Instead, let's create a minimal API handler
  // that returns product data directly.
  
  const express = require('express');
  app = express();
  app.use(express.json());

  // In-memory data store for Vercel (no SQLite in serverless)
  const products = [
    { id: 1, name: "iO2 Performance Bottle", slug: "performance-bottle", description: "Our flagship 500ml bottle with 25mg/L dissolved oxygen. Engineered for peak athletic performance.", shortDescription: "500ml premium oxygen-enriched water for peak performance", price: 3.99, comparePrice: 4.99, category: "singles", benefit: "performance", imageUrl: "io2-performance-bottle", badge: "Best Seller", rating: 4.9, reviewCount: 2847, stock: 500, unitCount: 1, unitSize: "500ml", accentColor: "#00d4ff", isSubscription: false, subscriptionPrice: null },
    ...
    { id: 4, name: "iO2 Brain Boost", slug: "brain-boost", description: "500ml cognitive performance formula. Enhanced oxygen delivery to support mental clarity.", shortDescription: "500ml cognitive clarity and focus formula", price: 4.99, comparePrice: null, category: "singles", benefit: "brain", imageUrl: "io2-brain-boost", rating: 4.8, reviewCount: 1256, stock: 400, unitCount: 1, unitSize: "500ml", accentColor: "#3b82f6", isSubscription: false, subscriptionPrice: null },
    { id: 5, name: "iO2 Athlete Pack", slug: "athlete-pack", description: "12-pack of 500ml Performance Bottles.", shortDescription: "12x 500ml Performance Bottles — save 17%", price: 39.99, comparePrice: 47.88, category: "bundles", benefit: "performance", imageUrl: "io2-variety-pack", badge: "Save 17%", rating: 4.9, reviewCount: 967, stock: 200, unitCount: 12, unitSize: "500ml", accentColor: "#00d4ff", isSubscription: false, subscriptionPrice: null },
    { id: 6, name: "iO2 Recovery Bundle", slug: "recovery-bundle", description: "24-pack of 355ml Recovery Cans.", shortDescription: "24x 355ml Recovery Cans — save 16%", price: 59.99, comparePrice: 71.76, category: "bundles", benefit: "recovery", imageUrl: "io2-can", badge: "Save 16%", rating: 4.8, reviewCount: 634, stock: 150, unitCount: 24, unitSize: "355ml", accentColor: "#00ff88", isSubscription: false, subscriptionPrice: null },
    { id: 7, name: "iO2 Starter Kit", slug: "starter-kit", description: "Try all 4 iO2 formulas plus 2 bonus bottles.", shortDescription: "6-variety sampler — try every formula", price: 24.99, comparePrice: 29.93, category: "bundles", benefit: "starter", imageUrl: "io2-variety-pack", badge: "Try All", rating: 4.9, reviewCount: 1578, stock: 300, unitCount: 6, unitSize: "Mixed", accentColor: "#f59e0b", isSubscription: false, subscriptionPrice: null },
    { id: 8, name: "iO2 Monthly Subscription", slug: "monthly-subscription", description: "24 bottles delivered monthly. Subscribe and save 20%.", shortDescription: "24 bottles/month — save 20% + free shipping", price: 49.99, comparePrice: 62.50, category: "subscriptions", benefit: "performance", imageUrl: "io2-variety-pack", badge: "Save 20%", rating: 4.9, reviewCount: 2103, stock: 999, isSubscription: true, subscriptionPrice: 49.99, unitCount: 24, unitSize: "500ml", accentColor: "#00d4ff" }
  ];

  const reviews = [
    { id: 1, productId: 1, name: "Marcus T.", rating: 5, title: "Game changer for my training", body: "NFL strength coach here. My athletes noticed the difference within the first week.", verified: true, createdAt: "2026-03-01" },
  ...
  app.get('/api/orders', (req, res) => res.json([
    { id: 1, userId: 1, status: "delivered", total: 45.97, subtotal: 39.98, shipping: 0, tax: 5.99, createdAt: "2026-03-15" },
    { id: 2, userId: 1, status: "shipped", total: 32.96, subtotal: 28.96, shipping: 0, tax: 4.00, createdAt: "2026-03-18" },
    { id: 3, userId: 1, status: "processing", total: 54.99, subtotal: 49.99, shipping: 0, tax: 5.00, createdAt: "2026-03-20" }
  ]));
  ...
  app.get('/api/admin/stats', (req, res) => res.json({
    ...
    revenueByMonth: [
      { month: "Jan", revenue: 15200 }, { month: "Feb", revenue: 22400 }, { month: "Mar", revenue: 31850 }
    ],
    ordersByMonth: [
      { month: "Jan", orders: 412 }, { month: "Feb", orders: 589 }, { month: "Mar", orders: 847 }
    ],
